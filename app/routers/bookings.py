...
from ..services.refunds import calculate_refund_cents, log_refund
...
@router.post("/bookings", status_code=200)
def create_booking(
...
def cancel_booking(
    ...
    # Atomic status flip to prevent concurrent cancel race conditions
    updated_rows = (
        db.query(Booking)
